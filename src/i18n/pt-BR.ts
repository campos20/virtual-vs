...
export const ptBR: TranslationDictionary = {
  ...
  folder: {
    ...
    createFailed:
      "Não foi possível criar a pasta. Verifique se há espaço livre no dispositivo.",
  ...
  projectForm: {
    ...
    tempoHintNone:
      "Nenhum tempo definido, então este projeto toca sem o click do metrônomo.",
    tempoHintSet:
      "O click é gerado a partir deste tempo e enviado ao bus de cue (L).",
    keyLabel: "TOM",
  ...
  markers: {
    heading: "Marcadores",
    emptyText:
      "Nenhum marcador ainda. Toque em um predefinido ou digite um nome e adicione na posição atual.",
  ...
  lyrics: {
    ...
    editHint:
      "Salvar apaga a sincronização por toque existente, já que as linhas podem não corresponder mais.",
